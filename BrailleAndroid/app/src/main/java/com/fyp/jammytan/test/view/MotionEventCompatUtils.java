...
package com.fyp.jammytan.test.view;
...
public class MotionEventCompatUtils {
     ...
     * 
     * @return The event source or {@link InputDeviceCompatUtils#SOURCE_UNKNOWN}
     *         if unknown.
     */
    public static int getSource(MotionEvent event) {
        return (Integer) CompatUtils.invoke(event, InputDeviceCompatUtils.SOURCE_UNKNOWN,
                METHOD_getSource);
    }
