...
import com.fyp.jammytan.test.utils.MotionEventUtils;
import com.fyp.jammytan.test.utils.SharedPreferencesUtils;
import com.fyp.jammytan.test.utils.WeakReferenceHandler;
...
public final class OverlayDisplay implements Display,
    ...
    public void displayDots(byte[] patterns, CharSequence text) {
        mBackingDisplay.displayDots(patterns, text);
        mMainThreadHandler.displayDots(getDisplayProperties(), patterns, text);
    }
