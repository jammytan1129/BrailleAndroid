...
import com.fyp.jammytan.test.provider.SettingsCompatUtils.SecureCompatUtils;
...
public class TtsEngineUtils {
     ...
     * value from {@link SecureCompatUtils#TTS_DEFAULT_LOCALE}, failing which
    ...
    public static Locale getDefaultLocaleForEngine(Context context, String engineName) {
        ...
        final String defaultLocalePref = Settings.Secure.getString(
                resolver, SecureCompatUtils.TTS_DEFAULT_LOCALE);
