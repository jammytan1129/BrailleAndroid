...
import com.fyp.jammytan.test.display.DisplayClient;
import com.fyp.jammytan.test.brailleback.utils.BrailleKeyBindingUtils;
...
public class SearchTutorialActivity extends Activity
    ...
    private void populateTutorialText() {
        ...
        BrailleDisplayProperties props = null;//mDisplay.getDisplayProperties();
        if (props == null) {
            return;
        }
