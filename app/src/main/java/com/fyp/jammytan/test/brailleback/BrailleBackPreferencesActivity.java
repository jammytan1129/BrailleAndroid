...
//        mEightDotTablePreference.setOnPreferenceChangeListener(this);
        mGroupInfo = findPreferenceByResId(
                R.string.pref_group_info_key);
        mGroupInfo.setOnPreferenceClickListener(this);
